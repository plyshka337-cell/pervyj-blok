...
if (calcBtn) {
    calcBtn.addEventListener('click', () => {
        ...
        const netArea = wallArea - openings; // вычитаем проёмы
        const blocksCount = Math.ceil(netArea / (0.625 * 0.25));
        ...
        resultDiv.innerHTML = `
            ...
            💰 Цена: <strong>${totalPrice.toFixed(0)} ₽</strong><br>
            ${openings > 0 ? `🪟 Проёмы: <strong>${openings} м²</strong> (вычтены)` : ''}
        `;
    });
}
